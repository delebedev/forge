...
- `HumanCostDecision` sacrifice, discard, return, unattach, ordinary tap, and untap selection — routes exact-count choices through `PlayerController.chooseCardsForCost()`
