...
- `TargetSelection` — routes single-candidate triggered targets through the controller callback
...
## Fixes
- `ComputerUtilMana` — uses net-positive paid mana sources while excluding net-zero filters from available casting mana
