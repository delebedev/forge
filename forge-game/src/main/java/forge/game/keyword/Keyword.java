...
public enum Keyword {
    ...
    PARADIGM("Paradigm", SimpleKeyword.class, false, "Then exile this spell. After you first resolve a spell with this name, you may cast a copy of it from exile without paying its mana cost at the beginning of each of your upkeeps."),
