...
public final class ResearchCandidateFeatures {
    ...
    public static final String METAMORPHIC_ATTACH_ADMISSION = "metamorphic-attach-admission";
    ...
    private static final Set<String> KNOWN = new LinkedHashSet<>(Arrays.asList(
            CAST_TRIGGER_MAIN1, METAMORPHIC_ATTACH_ADMISSION, MANDATORY_ETB, TOPK_RERANK, PREDICT_PROBE));
