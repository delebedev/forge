...
public class ResearchCandidateFeaturesTest {
    ...
    public void parsesKnownSubset() {
        ...
        Set<String> selected = ResearchCandidateFeatures.parse(
                " cast-trigger-main1 , mandatory-etb, pumpall-x-admission ");
        Assert.assertEquals(selected, Set.of(
                ResearchCandidateFeatures.CAST_TRIGGER_MAIN1,
                ResearchCandidateFeatures.MANDATORY_ETB,
                ResearchCandidateFeatures.PUMPALL_X_ADMISSION));
    }
    ...
    public void unsetEnvironmentEnablesEveryKnownFeature() {
        ...
        Assert.assertTrue(ResearchCandidateFeatures.isEnabled(ResearchCandidateFeatures.PUMPALL_X_ADMISSION));
    }
}
