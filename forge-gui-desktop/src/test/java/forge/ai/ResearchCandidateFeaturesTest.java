...
public class ResearchCandidateFeaturesTest {
    ...
    public void unsetEnvironmentEnablesEveryKnownFeature() {
        ...
        Assert.assertTrue(ResearchCandidateFeatures.isEnabled(ResearchCandidateFeatures.SORCERY_TAP_PUMP));
    }
}
